...
echo "<img src='http://localhost:8080/no-yes.gif' style='
margin-left:350px;'/>";

echo '<h2><p style="margin-left:250px;">click the proceed button to book an available seat in a particular event</p></h2>';
echo "</br><a href='http://localhost:8080/participantseatbook.php'><button
